	...
	<div class="card profile-card">
		...
		<div class="profile-body">
			<div class="image-area">
				<img src="@if(isset($admin->avatar)) {{Storage::disk('public')->url('profile/'.$admin->avatar)}} @else {{asset('backEnd/profile/profile.jpg')}}@endif" alt="Profile Image" width="65%" height="65%">
			</div>
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade active in" id="home">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="form-line focused">
										<input type="text" class="form-control" id="NameSurname" name="name" value="{{$admin->name}}" required="">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-10">
									<div class="form-line">
										<input type="text" class="form-control" id="NameSurname" name="address" value="kolabagan" required="">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="form-line">
										<input type="text" class="form-control" id="NameSurname" name="phone_number" placeholder="Name Surname" value="01790672620" required="">
									</div>
								</div>
							</div> --}}
